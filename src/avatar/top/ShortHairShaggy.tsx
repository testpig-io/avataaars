...
const ShortHairShaggy: FC = ({ children }) => {
    ...
    <g strokeWidth='1' fillRule='evenodd'>
      ...
      <g mask={`url(#${mask2})`}>
        <g transform='translate(-1.000000, 0.000000)'>
          ...
          {/*TODO: some how the mask is broken, fix it later.*/}
          <use stroke='none' fill='#28354B' fillRule='evenodd' transform='translate(143.465161, 67.234158) scale(-1, 1) translate(-143.465161, -67.234158)'
               xlinkHref={'#' + path1}/>
