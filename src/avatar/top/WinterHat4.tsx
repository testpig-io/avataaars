  ...
  return (
    <g>
      ...
      <g transform='translate(-1.000000, 0.000000)'>
        <g strokeWidth='1' fillRule='evenodd' transform='translate(65.000000, 4.000000)'>
          ...
          <use fillOpacity='0.24' fill='#000000' xlinkHref={'#' + path2}/>
          <mask id={mask4} fill='white'>
            <use xlinkHref={'#' + path3}/>
          </mask>
          <use fillOpacity='0.300000012' fill='#FFFFFF' xlinkHref={'#' + path3}/>
        </g>
        <g>
